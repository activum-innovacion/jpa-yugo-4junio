...
const es = {
  ...
  hero: {
    ...
    title: "Visítanos el\n17 de julio",
    subtitle: "Última oportunidad para conseguir un mejor precio",
    address: "C. Francisco de Xerez, 41092 Sevilla",
    times: "10:30 · 12:00 · 13:30",
  },
  form: {
    heading: "Reserva tu visita",
    subheading: "Viernes 17 de julio · Plazas limitadas",
    ...
    successDate: "viernes 17 de julio",
    successAt: "a las",
...
const en: typeof es = {
  ...
  hero: {
    badge: "Open House",
    title: "Visit us on\nJuly 17th",
    subtitle: "Last chance to get a better price",
    address: "C. Francisco de Xerez, 41092 Sevilla",
    times: "10:30 · 12:00 · 13:30",
  },
  form: {
    heading: "Book your visit",
    subheading: "Friday, July 17th · Limited spots",
    name: "Full name",
